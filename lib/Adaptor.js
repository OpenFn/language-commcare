...
var _languageHttp = require("@openfn/language-http");
...
function fetchReportData(reportId, params, postUrl) {
  return _languageCommon.http.get(`api/v0.5/configurablereportdata/${reportId}/`, {
    ...
    callback: function (state) {
      ...
      return (0, _languageHttp.post)(postUrl, {
        body: reportData
